var tetrisModule = angular.module("tetrisModule", []);



tetrisModule.provider("tetris", function() {
	var largeur = 0;
	var hauteur = 0;
	...
	function Tetris(tetriminos) {
		this.tetriminos = tetriminos.query();
	...
	this.$get = ['tetriminos', function(tetriminos) {
		return new Tetris(tetriminos);
	}];
});
